...
// Fetch all logistics entries from the database
try {
    $stmt = $db->query("
...
<script>
    ...
    document.querySelector('#addTaskForm').addEventListener('submit', function (event) {
        ...
        if (!clientEmail || !title || !description || !startDate || !endDate) {
        ...
        <div class="modal-content">
            ...
            <form id="updateLogisticsForm" method="POST">
                <!-- Hidden Input for Logistics ID -->
                   <label for="logisticsID">Logistics ID:</label>
                <input type="text" id="logisticsId" name="logistics_id">
                ...
                <input type="email" id="updatedClientEmail" name="client_email" required>
